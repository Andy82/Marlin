...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  // Reach3D
  #define DEFAULT_bedKp 814.55
  #define DEFAULT_bedKi 134.36
  #define DEFAULT_bedKd 1234.56
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 635 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
 */
#define DEFAULT_MAX_FEEDRATE          { 500, 500, 16, 25 }
...
//AB для проверки точности зонда
...
#define MIN_SOFTWARE_ENDSTOPS
  ...
  //AB запрет движений осей за программные пределы области печати -
...
//#define DEBUG_LEVELING_FEATURE
  ...
  //#define PROBE_Y_FIRST
    ...
    //AB Синтезирует промежуточные точки, чтобы получить более подробную сетку. 
...
// AB Позволяем хоумить(отправлять домой) отдельно каждую ось.
